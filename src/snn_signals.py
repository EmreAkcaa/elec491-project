...
- Complements the rate-coded Echo State Network (src/reservoir_computing.py)
  with a spike-coded counterpart — covers both ends of the neural computation
  spectrum used in modern signal-processing hardware.
