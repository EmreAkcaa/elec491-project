...
Graphical LASSO, Wavelet multi-scale, Transfer Entropy, Information
Theory, Spiking Neural Network) as one of the dashboard's primary
lenses, not as a tab to flip past.
...
Per-universe gating (``has_snn`` to hide Neuromorphic Signals on EEG)
is already handled inside ``eee_analysis.render()``.
"""
